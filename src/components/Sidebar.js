...
function Sidebar() {
  ...
  return (
    ...
    <div id='sidebar' className='fixed z-50 top-0 left-[-20rem] h-screen w-56 md:w-80 bg-gray-100 transition-all duration-300 ease-linear border-r-8 border-primary'>
