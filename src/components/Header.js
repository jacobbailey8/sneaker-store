...
function Header() {
  ...
  return (
    <div className=' fixed z-30 top-0 w-screen bg-transparent flex items-center justify-between px-5 md:px-8'>
      <div id="overlay" className="absolute hidden left-0 top-0 w-screen h-screen bg-overlay z-10"></div>
        ...
        <a href="/sneaker-store"><img className="w-24 md:w-32" src={require("../img/logo.png")} alt="logo" /></a>
